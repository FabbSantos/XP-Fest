...
function Slide() {
    ...
    return (
        <>
            <motion.div ref={r} className='carousel pb-20 lg:pb-0 max-w-screen lg:max-w-[1400px]'
                whileTap={{ cursor: "grabbing" }}
            >
                <img src="./src/assets/arrow_left.png" alt="arrow-left" className=' pointer-events-none w-[300px] absolute hidden lg:block bottom-0 left-0' />
                <img src="./src/assets/arrow_right.png" alt="arrow-right" className=' pointer-events-none w-[300px] absolute hidden lg:block bottom-0 right-0' />
                ...
                <motion.div
                    ...
                    <motion.div className='item'>
                        <img src="./src/assets/samsung-logo.svg" width="200px" alt='Samsung'></img>
                    ...
                    <motion.div className='item'>
                        <img src="./src/assets/burger-king.svg" width="160px" alt='Burger King'></img>
                        <motion.div className='item-content'>
